...
6. create  view  client_view  as select client_no, name, address1 as add1, address2 as add2, city, pincode as pcode, state from client_mast
7. select name from client_view where city = 'Bombay';
8. drop view client_view;
